...
Messages ==
  ...
  (* such a message.                                                       *)
  (*************************************************************************)
  (* the below equation is interpretted as, the set of messages sent by resource manager rm with type "Prepared"
     and union of set of messages with type as "Commit" or "Abort" (sent only by transaction manager) *)
  [type : {"Prepared"}, rm : RM]  \cup  [type : {"Commit", "Abort"}] \* \cup is union operator
...
TMCommit ==
  (*************************************************************************)
  (* The TM commits the transaction; enabled if the TM is in its initial  *)
...
RMPrepare(r) == 
  ...
  (*************************************************************************)
  /\ rmState[r] = "working"
  /\ rmState' = [rmState EXCEPT ![r] = "prepared"] \* rmState is set to "prepared" for rmState[r]. All other remains same
...
\* Last modified Thu Aug 31 17:36:53 SGT 2017 by Navi-PC
\* Created Thu Aug 31 16:10:48 SGT 2017 by Navi-PC
